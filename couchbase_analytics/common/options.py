...
from couchbase_analytics.common.options_base import (
    ClusterOptionsBase,
    FetchResultsOptionsBase,
    QueryOptionsBase,
    SecurityOptionsBase,
    StartQueryOptionsBase,
    TimeoutOptionsBase,
)
from couchbase_analytics.common.options_base import ClusterOptionsKwargs as ClusterOptionsKwargs  # noqa: F401
from couchbase_analytics.common.options_base import FetchResultsOptionsKwargs as FetchResultsOptionsKwargs  # noqa: F401
...
from couchbase_analytics.common.options_base import StartQueryOptionsKwargs as StartQueryOptionsKwargs  # noqa: F401
...
class FetchResultsOptions(FetchResultsOptionsBase):
    """Available options for Analytics asynchronous server query fetch results operation.
...
class TimeoutOptions(TimeoutOptionsBase):
    ...
    Args:
        ...
        handle_request_timeout (Optional[timedelta]): Set to configure the period of time allowed for HTTP requests when using the server asynchronous requests API. Defaults to `None` (10s).
...
class QueryOptions(QueryOptionsBase):
    ...
    Args:
        ...
        named_parameters (Optional[Dict[str, :py:type:`~couchbase_analytics.JSONType`]]): Values to use for named placeholders in query.
        positional_parameters (Optional[List[:py:type:`~couchbase_analytics.JSONType`]]): Values to use for positional placeholders in query.
...
class StartQueryOptions(StartQueryOptionsBase):
