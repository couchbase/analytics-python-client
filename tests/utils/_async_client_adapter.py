...
async def create_client_override(self) -> None:
...
async def send_request_override(self, request: QueryRequest) -> Response:
    if not hasattr(self, '_client'):
...
_AsyncClientAdapter.create_client = create_client_override
_AsyncClientAdapter.send_request = send_request_override
